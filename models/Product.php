...
class Product
{
    ...
    public static function updateProductById($id, $options)
    {
        ...
        $result->bindParam(':description2', $options['description2'], PDO::PARAM_STR);
        $result->bindParam(':description3', $options['description3'], PDO::PARAM_STR);
        $result->bindParam(':description4', $options['description4'], PDO::PARAM_STR);
        $result->bindParam(':description5', $options['description5'], PDO::PARAM_STR);
        $result->bindParam(':description6', $options['description6'], PDO::PARAM_STR);
    ...
    public static function getSearchProduct($search){
        ...
        $result = $db->query("SELECT id, name, price, code, is_new FROM product where `name` like '%".$search."%' or `description` like '%".$search."%' ORDER BY id ASC");
        $productsList = array();
        $i = 0;
        if($result){
            while ($row = $result->fetch()) {
