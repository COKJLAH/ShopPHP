                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i> +38 068 366 26 77</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> danilodorogan92@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div> 
                        </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="mainmenu pull-left">
                                    <ul class="nav navbar-nav collapse navbar-collapse">
                                        ...
                                        <li><a href="/catalog/">Категорії</a></li>       
                                        </li>
                                        <li><a href="/about/">О магазині</a></li>
                                        <li><a href="/contacts/">Контактні данні</a></li>
                                    </ul>
